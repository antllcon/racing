...
fun detectCollision(car1: Car, car2: Car): CollisionResult {
    ...
    var collisionNormal = Offset.Zero
...
private fun applyImpulse(car1: Car, car2: Car, result: CollisionResult) {
    ...
    val v1 = Offset(cos(car1.direction) * car1.speed, sin(car1.direction) * car1.speed)
    val v2 = Offset(cos(car2.direction) * car2.speed, sin(car2.direction) * car2.speed)
...
private fun findContactPoint(vertices1: List<Offset>, vertices2: List<Offset>): Offset {
    var contactPoint = Offset.Zero
...
private fun dot(o1: Offset, o2: Offset): Float = o1.x * o2.x + o1.y * o2.y
private fun crossProduct(offset: Offset, scalar: Float): Offset = Offset(-scalar * offset.y, scalar * offset.x)
private fun crossProduct(a: Offset, b: Offset): Float = a.x * b.y - a.y * b.x
